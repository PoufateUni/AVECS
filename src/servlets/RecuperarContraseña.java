...
/**
 * Servlet implementation class RecuperarContraseÃ±a
 */
...
public class RecuperarContraseña extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        email.enviarEmail(emailReceptor, "Cambio de ContraseÃ±a (Prueba AVECS)", "SU CONTRASEÃ‘A ES=" +usuario.getContrasena());
